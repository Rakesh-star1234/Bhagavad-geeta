...
function renderSaved() {
  ...
  if (
    ...
    box.innerHTML = `
      ...
      >
        No saved verses yet.
        Use the ❤️ button inside a verse.
      </p>
    ...
    prefs.saved
      .map(
        (saved) => `
          ...
          <div
            class="flex items-center justify-between gap-3 border border-saffron/20 rounded-xl p-3"
          >
  ...
  new MutationObserver(
    () => {
      ...
      if (saveVerseButton) {
        ...
        saveVerseButton.onclick =
          () => {

            const index =
              prefs.saved.findIndex(
                (item) =>
                  item.c ===
                    chapter &&
                  item.v ===
        ...
        copyButton.onclick =
          async () => {
            ...
            try {
              ...
              alert(
                "Copy was not available in this browser."
              );
            }
          };
      }
...
const quizQuestions = [
  ...
  {
    question:
      "Which chapter contains the famous verse 2.47?",
  ...
  {
    question:
      "Who gives the teachings of the Gita to Arjuna?",
  ...
  {
    question:
      "The dialogue takes place on the battlefield of…",
  ...
  {
    question:
      "What is a central theme of Karma Yoga?",

    options: [
      "Avoid all work",
      "Act with discipline without attachment to results",
      "Only meditate",
      "Seek wealth"
    ],
...
function showQuizQuestion() {
  ...
  if (!question) {
    ...
    quizBox.innerHTML = `
      ...
      <div
        class="rounded-2xl bg-cream p-6 text-center"
      >
        ...
        <h3
          class="font-display text-2xl text-maroon mt-2"
        >
          Quiz complete
        </h3>
  ...
  quizBox.innerHTML = `
    ...
    <div
      class="grid sm:grid-cols-2 gap-3 mt-4"
    >
      ...
      ${question.options
        .map(
          (option, index) => `
            ...
            <button
              class="quiz-option text-left border border-saffron/25 rounded-xl p-3 hover:border-maroon transition"
              data-option="${index}"
            >
              ${String.fromCharCode(
                65 + index
